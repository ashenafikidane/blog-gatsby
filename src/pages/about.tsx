...
import authorData from "../data/authors/ashenafi.json";
    ...
    <Layout>
      <SEO
        ...
        description={`Learn more about ${
          authorData.name
        }, a ${authorData.title.toLowerCase()} passionate about React, Node.js, and modern web technologies.`}
      />
                  ...
                  <div className="w-32 h-32 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                    {authorData.image ? (
                      ...
                      <span className="text-4xl font-bold">
                        {generateInitials(authorData.name)}
                      </span>
                    )}
                  </div>
                  <h2 className="text-2xl font-bold">{authorData.name}</h2>
                  <p className="text-blue-100">{authorData.title}</p>
                </div>
              </div>
            </div>
